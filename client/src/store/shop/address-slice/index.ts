...
export const addNewAddress = createAsyncThunk(
  ...
  async (formData: Omit<Address, "id">) => {
    const response = await axios.post(
      "https://ecommerce-store-olive-delta.vercel.app/api/shop/address/add",
      formData
    );
...
export const fetchAllAddresses = createAsyncThunk(
  ...
  async (userId: string) => {
    const response = await axios.get(
      `https://ecommerce-store-olive-delta.vercel.app/api/shop/address/get/${userId}`
    );
    return response.data;
  }
);
...
export const editaAddress = createAsyncThunk(
  ...
  async ({ userId, addressId, formData }: { userId: string; addressId: string; formData: Omit<Address, "id"> }) => {
    const response = await axios.put(
      `https://ecommerce-store-olive-delta.vercel.app/api/shop/address/update/${userId}/${addressId}`,
      formData
    );
    return response.data;
  }
...
export const deleteAddress = createAsyncThunk(
  ...
  async ({ userId, addressId }: { userId: string; addressId: string }) => {
    const response = await axios.delete(
      `https://ecommerce-store-olive-delta.vercel.app/api/shop/address/delete/${userId}/${addressId}`
    );
    return response.data;
  }
);
